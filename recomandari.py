...
file_path = 'transactions.xlsx'  # Update the file path to your Excel file
...
import openai
openai.api_key = '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'
...
if customer_id_input in top_n_recommendations:
    ...
    personalized_message = generate_personalized_message(customer_id_input, product_id)
